...
| `projects` | cualquier autenticado | crear: gestor/admin o cualquier analista (válvula de escape del diálogo de tarea); editar: `can_manage_project()` — gestor/admin o quien está en su equipo; **eliminar: solo gestor/admin**, porque se lleva por delante horas, fases, tareas y comentarios de todos los meses |
